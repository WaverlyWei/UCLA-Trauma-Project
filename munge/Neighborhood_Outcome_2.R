...
testHeatmap<-function(dat, annotation) {    
  ...
  sampleColors1 <- mapVarToColor("YlOrRd",annotation_latino)
  sampleColors2 <- mapVarToColor("YlOrRd",annotation_pbpl)
  sampleColors3 <- mapVarToColor("YlOrRd",annotation_under5)
  sampleColors4 <- mapVarToColor("YlOrRd",annotation_over85)
  ...
  h1 <- heatmap.plus(try, margins=c(8,10),
                             main="Variable Importance Measures",
                     keep.dendro = TRUE,add.expr = abline(v=c(3.5,5.5,10.5,14.5)))

  
  
                 #rowsep=c(3,8))
  #legendfun=function()showLegend(legend=c("MiracleDr
...
NeighborhoodHeatmap<-function(dat, annotation) {    
  ...
  sampleColors3 <- mapVarToColor("YlOrRd",annotation_under5)
  sampleColors4 <- mapVarToColor("YlOrRd",annotation_over85)
  sampleColors5 <- mapVarToColor("YlOrRd",annotation_mhi)
  ...
  heatmap.plus(df.N, margins=c(8,10),
               ...
               keep.dendro = TRUE,add.expr = abline(v=c(3.5,10.5,12.5,15.5,22.5,28.5)))
